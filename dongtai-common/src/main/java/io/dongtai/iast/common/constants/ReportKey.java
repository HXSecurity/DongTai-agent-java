...
public class ReportKey {
    ...
    public static final String METHOD_POOL = "pool";

    public static final String IS_CORE_INSTALLED = "isCoreInstalled";
    public static final String IS_CORE_RUNNING = "isCoreRunning";
