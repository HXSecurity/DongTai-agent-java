...
public class ApiPath {
    public static final String AGENT_REGISTER = "/api/v1/agent/register";
    public static final String ACTUAL_ACTION = "/api/v1/actual_action";
    public static final String EXCEPT_ACTION = "/api/v1/except_action";
