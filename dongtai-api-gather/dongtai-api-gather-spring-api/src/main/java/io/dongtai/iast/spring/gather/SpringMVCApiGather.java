package io.dongtai.iast.spring.gather;

import io.dongtai.iast.openapi.domain.OpenApi;
import io.dongtai.iast.spring.convertor.RequestMappingHandlerMappingConvertor;
 ...
 * @since v1.12.0
 */
public class SpringMVCApiGather {
     ...
     * @return
     */
    public static OpenApi gather(Object applicationContext) {
        WebApplicationContext webApplicationContext = (WebApplicationContext) applicationContext;
        SpringMVCApiGather springApplicationContext = new SpringMVCApiGather();
