...
public class HeavyTrafficLimitReportBody {
    ...
    private Integer type = ReportConstant.REPORT_LIMIT_REQUEST_RATE;
    /**
     * 报告详情
     */
    ...
    public static class HeavyTrafficLimitDetail {
         ...
         * 限流发生时间
         */
        @SerializedName(ReportConstant.LIMIT_REQUEST_LIMIT_DATE)
        private Date limitDate;
        /**
         * 限流阈值
         */
        @SerializedName(ReportConstant.LIMIT_REQUEST_RATE)
