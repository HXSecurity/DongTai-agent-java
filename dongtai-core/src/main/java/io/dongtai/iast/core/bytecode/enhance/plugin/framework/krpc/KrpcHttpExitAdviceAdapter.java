...
public class KrpcHttpExitAdviceAdapter extends AbstractAdviceAdapter{

    private int athrowCounts = 0;

    public KrpcHttpExitAdviceAdapter(MethodVisitor mv, int access, String name, String desc, String signCode, IastContext context) {
        super(mv, access, name, desc, context, "krpc_http_exit", signCode);
    }
    ...
    private void leaveKrpc() {
        ...
        invokeInterface(ASM_TYPE_SPY_DISPATCHER, SPY$leaveKrpcHttp);
    }
}
